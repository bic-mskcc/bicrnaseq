...
#'             (strings or numbers) and the second-Nth columns contains only numbers
#' @return a matrix containing averages of values whose names were the
#'         the same in the original matrix, plus the original values in the second-Nth 
#'         columns of the input matrix whose 'names' were unique
#' @export
...
#' @param skip number of lines to skip before reading file
#' @export
...
#' @return data matrix with new rownames and one less column
#' @export
